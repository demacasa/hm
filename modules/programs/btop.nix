...
in
{
  options.hm.btop.enable = lib.mkEnableOption "btop system monitor";

  config = lib.mkIf cfg.enable {

    home.file = {
      ".config/btop/themes/${config.hm.theme}.theme" = {
        text = ''
          # Main text color
    ...
    programs.btop = {
      ...
      settings = {
        ...
        disks_filter = "/ /nix /nix/state /nix/store /mnt/media /mnt/pool /mnt/usb_drive";
